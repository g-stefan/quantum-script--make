...
namespace Quantum {
	namespace Script {
		namespace Extension {
			namespace Make {
				namespace Copyright {
					QUANTUM_SCRIPT_EXTENSION_MAKE_EXPORT const char *copyright();
					QUANTUM_SCRIPT_EXTENSION_MAKE_EXPORT const char *publisher();
					QUANTUM_SCRIPT_EXTENSION_MAKE_EXPORT const char *company();
					QUANTUM_SCRIPT_EXTENSION_MAKE_EXPORT const char *contact();
					QUANTUM_SCRIPT_EXTENSION_MAKE_EXPORT const char *fullCopyright();
				};
			};
		};
	};
