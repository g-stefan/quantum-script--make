...
cmdX xyo-cc --mode=$ACTION @build/source/quantum-script-extension-make.static.compile
cmdX xyo-cc --mode=$ACTION @build/source/quantum-script-extension-make.dynamic.compile
